 ...
 */
@WebServlet("/ListarDirectoriosProcedimientos")
public class ListarDirectoriosProcedimientos extends HttpServlet {
     ...
     */
    public ListarDirectoriosProcedimientos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      String url=Constantes.urlProcedimientos;
