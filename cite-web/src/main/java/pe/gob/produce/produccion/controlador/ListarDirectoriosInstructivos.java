 ...
 */
@WebServlet("/ListarDirectoriosInstructivos")
public class ListarDirectoriosInstructivos extends HttpServlet {
     ...
     */
    public ListarDirectoriosInstructivos() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      String url=Constantes.urlInstructivos;
