 ...
 */
@WebServlet("/ListarDirectoriosGeneral")
public class ListarDirectoriosGeneral extends HttpServlet {
     ...
     */
    public ListarDirectoriosGeneral() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      String url=Constantes.urlDocumentos;
